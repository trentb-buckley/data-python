...
# console-log an 'A', between 80 and 89, console-log a 'B', between 70 and 79, 'C', between 60 and
...
friends.append('Trent')
print(friends)

# Problem 13
# Print out the total amount of elements in the `friends` array. The Python method you are 
# looking for is similar to the JavaScript property `.length`.
